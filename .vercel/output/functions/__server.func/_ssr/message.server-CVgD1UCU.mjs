...
import { n as prisma, t as createServerRpc } from "./db.server-D5jV7CVq.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/message.server-CVgD1UCU.js
...
var deleteConversationFn_createServerFn_handler = createServerRpc({
	id: "bc2c689f926e8060c51533463834a233b343eee3ee5c62f4bb989d7c62997b33",
	name: "deleteConversationFn",
	filename: "src/lib/message.server.ts"
}, (opts) => deleteConversationFn.__executeServer(opts));
var deleteConversationFn = createServerFn({ method: "POST" }).validator((data) => data).handler(deleteConversationFn_createServerFn_handler, async ({ data: { userId, partnerId } }) => {
	await prisma.message.deleteMany({ where: { OR: [{
		senderId: userId,
		receiverId: partnerId
	}, {
		senderId: partnerId,
...
//#endregion
export { deleteConversationFn_createServerFn_handler, getConversationsFn_createServerFn_handler, getMessagesFn_createServerFn_handler, getUnreadMessagesCountFn_createServerFn_handler, markMessagesAsReadFn_createServerFn_handler, sendMessageFn_createServerFn_handler, withdrawMessageFn_createServerFn_handler };
