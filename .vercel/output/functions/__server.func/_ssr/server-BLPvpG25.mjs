...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-BXMzkYr1.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BSRuLnb3.mjs");
