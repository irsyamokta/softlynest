...
import { t as Route } from "./_shell.messages._messageId-sa4TSXz-.js";
import { t as EmojiPicker } from "./EmojiPicker-CJFW-xdf.js";
import { a as getProfileByUsernameFn } from "./auth.server-C3pOWsG0.js";
import { a as sendMessageFn, i as markMessagesAsReadFn, n as getMessagesFn } from "./message.server-DMm0u0Ia.js";
import { useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { ArrowLeft, Send } from "lucide-react";
//#region src/routes/_shell.messages.$messageId.tsx?tsr-split=component
...
function ChatRoom() {
	...
	if (!conversation) return /* @__PURE__ */ jsxs("div", {
		className: "flex flex-col items-center justify-center min-h-screen px-4 text-muted-foreground bg-nest",
		children: [/* @__PURE__ */ jsx("p", { children: "Conversation not found." }), /* @__PURE__ */ jsx(Link, {
			to: "/messages",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [dbMessages.map((msg) => {
					...
					return /* @__PURE__ */ jsxs("div", {
						...
						children: [!isMe ? /* @__PURE__ */ jsx("img", {
							src: conversation.avatar,
							alt: conversation.user,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(EmojiPicker, { onEmojiSelect: insertEmoji }),
					/* @__PURE__ */ jsx("div", {
